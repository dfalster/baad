...
1. Our entire work flow is scripted, using the R computing environment `r citep(citation("base"))`. The database can be rebuilt in an instant from the raw datafiles, using a single command. When a single data contribution has been modified, the final master dataset is thus easily recreated.
