...
#these commands below from package knitcitations work if you knit the file from within RStudio (being in the right ms directory), but they do not work when you generate the file using make.
#not working
#citep(c(Falster2011="10.1111/j.1365-2745.2010.01735.x"))
#citep(citation("base"))
#r citet("https://github.com/dfalster/dataMashR")
```
