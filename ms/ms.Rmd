...
writeLines(paste("**List of Authors:** ", paste0(details$authors, "^", details$address_code,"^",collapse = ", ") ))

writeLines("\n\n")

writeLines(paste0(details$address$code, ". ", details$address$address, collapse="\n"))
```
...
iii) All species names were matched against online databases with the R packages `Taxonstand` and `taxize` R package citet(c("10.1111/j.2041-210X.2012.00232.x", bib["chamberlain2013taxize"]))`.
