...
knitr:::opts_chunk$set(tidy=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap="", cache=TRUE)
...
vars <- vars[-c(match(c("map","mat","lai","age"),vars))]
