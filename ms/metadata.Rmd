...
**Latest update**: The dataset made available through this publication was processed on 2014-12-15. Newer updates may be retrieved from the BAAD website [github.com/dfalster/baad](https://github.com/dfalster/baad).
...
**1. Storage location and medium**: The data published on Ecological Archives is the first release from the Biomass and allometry database (v1.0.0) stored at [github.com/dfalster/baad](https://github.com/dfalster/baad/). The version of the data contained in this publication can also be downloaded from the releases page on gihtub: [github.com/dfalster/baad/releases](https://github.com/dfalster/baad/releases). Development versions of the dataset will continue to be made available at [github.com/dfalster/baad](https://github.com/dfalster/baad).

If you notice any problems with the dataset, please list an issue at [github.com/dfalster/baad/issues/new](https://github.com/dfalster/baad/issues/new).
...
**Copyright restrictions**: The dataset is released under the the [Creative Commons Zero](https://creativecommons.org/publicdomain/zero/1.0/) public domain dedication. When using the dataset, we kindly request that you cite this article, recognizing the hard work that went into collecting the data and the authors' willingness to make it publicly available.
